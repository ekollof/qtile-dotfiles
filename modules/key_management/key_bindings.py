...
class KeyBindings:
    ...
    def get_layout_keys(self):
        ...
        return [
            ...
            Key([self.mod], "x", lazy.function(self.window_commands.smart_maximize),
    ...
    def get_system_keys(self):
        ...
        return [
            ...
            Key([self.mod, "control"], "c", lazy.function(
                self.system_commands.manual_color_reload), desc="Reload colors"),
            Key([self.mod, "control"], "s", lazy.function(
                self.system_commands.manual_screen_reconfigure), desc="Reconfigure screens"),
            Key([self.mod, "control"], "f", lazy.function(
                self.system_commands.manual_retile_all), desc="Force retile all windows"),
        ]
    ...
    def get_special_keys(self):
        ...
        return [
            # Hotkey display
            Key([self.mod], "s", lazy.function(show_hotkeys_wrapper), desc="Show hotkeys"),
